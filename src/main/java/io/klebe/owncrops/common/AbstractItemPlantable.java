...
public class AbstractItemPlantable extends AbstractItem implements IPlantable {
	
	private AbstractBlockCrops cropToPlant;

	public AbstractItemPlantable(String unlocalizedName, AbstractBlockCrops crop) {
